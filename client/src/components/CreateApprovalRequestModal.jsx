...
function CreateApprovalRequestModal({ open, setOpen, createApprovalRequest }) {
  ...
  const create = async () => {
    try {
      ...
      createApprovalRequest({ description });
      setIsError(false);
      setNotificationTitle('Success');
      setNotificationDescription('An approval request has been made.');
    } catch (err) {
      setIsError(true);
      setNotificationTitle('Create Approval Request Error');
                  ...
                  <div className="px-4 sm:px-6 lg:px-8 pt-8 pb-16">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="mt-2 text-sm text-gray-700">
                        Admins will typically reply within one day.
                      </p>
...
CreateApprovalRequestModal.propTypes = {
  open: PropTypes.bool,
  setOpen: PropTypes.func,
  createApprovalRequest: PropTypes.func,
};

export default CreateApprovalRequestModal;
